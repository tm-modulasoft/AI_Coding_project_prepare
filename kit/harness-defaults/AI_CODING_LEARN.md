...
**Mandatory training** for anyone using this prepared AI-coding setup. Watch and read these intros first. Day-to-day commands and the house loop live in `AI_CODING_README.md`.
...
- **Hooks:** [Watch This If Your Coding Agent is Ignoring Your Rules](https://youtu.be/msfMqW92Y8Q)
...
(This prepare kit already restores that set via `skills-lock.json`. Use `add` when the upstream repo gained _new_ skills you do not have yet.)
