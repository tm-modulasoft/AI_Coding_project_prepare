...
# Tools (always)
- Docs/APIs: Context7. GitHub: gh CLI only (no GitHub MCP). Deps: Sonatype MCP.
- UI from Figma: FigmaLocal + the Figma MCP flow, token-driven layout. Only when I gave a Figma URL/node or asked to implement a design.
